# Source: https://github.com/thejaminator/latteries/blob/main/latteries/caller.py
import hashlib
...
def load_openrouter_caller(cache_path: str) -> MultiClientCaller:
    load_dotenv()
    ...
    clients = [
        CallerConfig(name="gpt", caller=openrouter_caller),
